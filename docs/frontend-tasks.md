...
#### 2.5.4 逆向工程目標法 (Reverse Engineering)
- [ ] 理想終點設定介面
- [ ] 時間軸回推工具 (年→季→月→週)
- [ ] 步驟拆解編輯器
- [ ] 資源需求評估 (金錢、時間、技能、人脈)
...
#### 2.5.7 生活滿意度儀表板 (Satisfaction Dashboard)
- [ ] 8 大生活面向評分介面：
  - [ ] 事業/工作
  - [ ] 財務/金錢
  - [ ] 健康/體能
...
#### 2.5.10 習慣堆疊設計 (Habit Stacking)
- [ ] 既有習慣列表選擇
- [ ] 新舊習慣連結介面
- [ ] 習慣鏈視覺化呈現
- [ ] 堆疊提醒設定

#### 2.5.11 每日反思 (Reflections)
- [ ] 反思日記編輯器
- [ ] 引導式反思問題
- [ ] 感恩日記區塊
- [ ] 心情記錄選擇器
...
#### 2.5.12 週回顧 (Weekly Review)
- [ ] 一週習慣完成總覽
- [ ] 目標進度檢視
- [ ] 下週計畫設定
- [ ] 週報產生功能

#### 2.5.13 成就系統 (Achievements)
- [ ] 徽章展示頁面
- [ ] 已獲得 vs 未解鎖徽章
- [ ] 獲得徽章動畫效果
- [ ] 成就進度條
